...
ค่าสำหรับระบุลง Parameters ทั้ง 4 ค่าที่กล่าวไปข้างต้น สามารถดูได้จาก |portal_url| ในส่วนของข้อมูล Device ดังรูปต่อไปนี้
...
.. note::
	...
	ปุ่ม Resync Status ใช้สำหรับอัพเดทสถานะการเชื่อมต่อ Platform ให้ถูกต้อง ในกรณีที่การแสดงผลบนหน้า Portal ไม่ถูกต้อง ให้คลิกที่ปุ่มดังกล่าวเพื่ออัพเดทสถานะได้
